...
//   let newMass = arr.filter(el => el.eyeColor === color)
//   return newMass.map(el => el.name);
// }
...
//   let newMass = arr.filter(el => el.gender === gender);
//   return newMass.map(el => el.name);
// };
...
//   const newArr = arr.filter(el => el.isActive);
...
//   const userByAge = arr.filter(el => el.age > min && el.age < max);
//   return userByAge.map(el => el.name);
// };
const getUsersWithAge = (arr, min, max) => arr
...
//   const totalBal = arr.reduce((acc, el) => acc + el.balance, 0);
//   return totalBal;
// };
...
//   const findNameByFriend = arr
//   .filter(el => el.friends.includes(name))
//   .map(el => el.name);
//   return findNameByFriend;
// }
